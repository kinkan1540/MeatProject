...
namespace Oikake.Objects
{
    class Map1
    {
        ...
        public virtual bool IsBloock(Vector2 position)
        {
        ...
        public virtual bool IsGoal(Vector2 position)
        {
            //その位置のマップチップ番号を見る
            int chipNum = ChipNum(position);
        ...
        public virtual bool IsTrap(Vector2 position)
        {
            int chipNum = ChipNum(position);
            if(chipNum==3)
            {
        ...
        public virtual int ChipNum(Vector2 position)
        {
